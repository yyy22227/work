			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="#" id="logo" style="color:#000000;border:3px green dotted;background-color:white">教 師 列 表</a></h1>
							</header>
						</div>
					...
					<!-- Nav -->
						...
						<div class="container" id="content" style="align:center;text-align:center">
								<article id="main">
								<header>
									<?php
										class Cases{
											...
											function show(){
													...
													echo "<td style=padding:15px>"."<input type='button' value='查看更多'onclick=location.href='show_case.php?member_id={$this->teacher_id}&case_type=teacher_case&case_id=$this->case_id&member_type=teacher'>"."</td>";
													echo "</tr style=padding:15px>";
											}
											}
										$teacher_case = array();
											$conn  = mysqli_connect('sql305.byethost7.com','b7_20212335','asdf0147','b7_20212335_team6');
											$sql = "SELECT * FROM teacher_case;";
											...
											,$row['salary'],$row['status'],$row['details'],$row['teacher_id'],$row['id'],$row2['name']);
												array_push($teacher_case,$temp);
											}
											...
											echo "<div class = container>";
												...
												echo "<th style=padding:15px;background-color:yellow>老師";
												...
												echo "<th style=background-color:yellow>狀態";
												echo "<th style=width:30px>";
												echo "</tr>";

											foreach($teacher_case as $m){
												$m->show();     
											}
											echo "</table>";
