			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="#" id="logo" style="color:#000000;border:3px green dotted;background-color:white">個 人 資 料</a></h1>
							</header>
						</div>
					...
					<section>
						<?php 
							...
							while($mes = $result->fetch_assoc()){
								...
								echo "<tr><td style=padding:15px align=center>"."<input type = 'button' value= '修改個人資料' onclick=location.href='update.php'>"."</td></tr>";
